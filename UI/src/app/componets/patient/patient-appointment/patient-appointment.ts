...
export class PatientAppointmentComponent {
  ...
  AddAppointment() {
    ...
    this.newAppointment.PatientID = this.patient?.ID || 0;
    this.newAppointment.UserID = this.dataService.getUser()?.ID || 0;
    ...
    this.newAppointment.PatientName = this.dataService.getUser()?.FirstName + ' ' + this.dataService.getUser()?.LastName || 'Unknown Patient';
  }
}